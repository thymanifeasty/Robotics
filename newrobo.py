...
right_motor = "472480076-41358630233090"
...
async def ho(s):
    ...
    elif Robot.get_value(line, "left"):
        x = -s
    ...
    Robot.set_value(right_motor, "duty_cycle",0)
    print("Stopped")
    Robot.set_value(door, "duty_cycle", 0.9)
    print("Openning")
    await Actions.sleep(1.0)
...
def teleop_main():
    ...
    A  = Gamepad.get_value("a_button", 0) #back
    B = Gamepad.get_value("b_button", 0)  #forward
